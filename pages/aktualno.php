<div class="text">
	<h1 align="center">Aktualno:</h1><br>
	<?php
		$sql = mysql_query("SELECT * FROM `news`");

		if (mysql_num_rows($sql) == 0) {
			echo "<br><h2 align=\"center\">Na naši internetni strani ni nobenih novic!</h2><br><br>";	 
		} else {
			global $user_data;

			$sql = mysql_query("SELECT * FROM news ORDER BY news_id DESC LIMIT 0, 5");
