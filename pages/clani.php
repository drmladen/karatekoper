<div class="text">
	...
	?>
	<h1 align="center">Rekreativci:</h1><br><br>
	<?php
		$sql = mysql_query("SELECT * FROM members WHERE status = 2");
	...
	<table class="dan">
		...
		<?php
			global $user_data;
			$query = mysql_query("SELECT * FROM members WHERE status = 2");
			$num_rows = mysql_num_rows($query);
			$num = 1;
			$num <= $num_rows;

			$sql = mysql_query("SELECT * FROM members WHERE status = 2 ORDER BY first_name ASC");
